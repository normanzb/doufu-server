...
doufu.SampleGame.Roles.Naked = function()
{
	...
	this.StandingOffset.Y = 47;
	
	this.ImagePath = CONFIG_CHARS_PATH + "Naked.gif";
	...
	this.AnimationInfos.StopLeft.Row = 1;
...
doufu.SampleGame.Items.House1 = function()
{
	$c(this);
...
doufu.SampleGame.Maps.Jungle = function(oPlayGround)
{
	...
	this.ImagePath = CONFIG_STAGES_PATH + "Jungle.gif";
	...
	var c0 = new doufu.SampleGame.Items.MediumCloud();
	c0.X = 600;
	c0.Y = 500;
	c0.Z = 1;
